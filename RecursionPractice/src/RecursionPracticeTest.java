...
public class RecursionPracticeTest {
	...
	public void testSummation() {
		...
		assertEquals(3, RecursionPractice.summation(2), 3);
		assertEquals(55, RecursionPractice.summation(10), 55);
		assertEquals(5050, RecursionPractice.summation(100), 5050);
		assertEquals(1275, RecursionPractice.summation(50), 1275);
	}
